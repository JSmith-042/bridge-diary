...
const StarRating = ({rating}:StarRatingProps) => {
    ...
    const handleStarClick = (e) => {
        if (!isNaN(+e.target.ariaLabel)) {
            setStars(+e.target.ariaLabel);
        }
    };
